...
banner.theme.template = 'BannerGeneralSsb' // This is the name of the scss file containing the theme settings in war file.
 ...
 *                                                                              *
 ***************************************************************************** **/
BCMLOCATION='<HOST_NAME>:<PORT>/CommunicationManagement' // Example localhost:8080/CommunicationManagement
BANNER_AIP_BLOCK_PROCESS_PERSONA=[]// List of Supported Persona  Example : ['EVERYONE', 'STUDENT', 'REGISTRAR', 'FACULTYINSTRUCTOR', 'FACULTYADVISOR', 'FACULTYBOTH']
BANNER_AIP_EXCLUDE_LIST='<UPDATE_ME>'// List of exclusion urls example: selfServiceMenu|login|logout|error|dateConverter
GENERALLOCATION='<HOST_NAME>:<PORT>/BannerGeneralSsb' // Example localhost:8080/BannerGeneralSsb

ssconfig.app.seeddata.keys = [['BCMLOCATION'], ['GENERALLOCATION'], ['BANNER_AIP_BLOCK_PROCESS_PERSONA'], ['BANNER_AIP_EXCLUDE_LIST']]
