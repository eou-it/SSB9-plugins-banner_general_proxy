...
grails.plugin.springsecurity.interceptUrlMap = [
        ...
        '/ssb/general/proxy/**':['IS_AUTHENTICATED_ANONYMOUSLY'],
        '/ssb/general/submitActionPassword/**':['IS_AUTHENTICATED_ANONYMOUSLY'],
        '/ssb/general/resetPinAction/**':['IS_AUTHENTICATED_ANONYMOUSLY'],
